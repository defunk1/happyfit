...
public class ItemListExercise  extends ArrayAdapter<String>{
		...
		public ItemListExercise (Context context, List<String> months){
			super(context, R.layout.exercise_list_item, months);
			mContext = context;
			mMonths = months;
		}
		...
		//	ParseObject voter = mVoters.get(position);
			...
			holder.subTitleLabel.setText(" for 30 minutes "  );
